    ...
    axios
      ...
      .then((response) => {
        ...
        if(response.status === 201){
          router.push("/pages/user/quizzes/algebra/resultados")
        }
      })
      .catch((error) => {
        console.error(error);
...
export default AlgebraQuizzForm;
